"""
compile_baseline_descriptives.py

Compiles all 50 baseline JSONs into a single structured descriptor file.
Output: baseline_descriptives.json

Expected input: ./output/*_baseline.json
...
# --- Config ---
OUTPUT_DIR = "./output"
OUTPUT_FILE = "./output/baseline_descriptives.json"
...
baseline_files = sorted(glob(os.path.join(OUTPUT_DIR, "*_baseline.json")))
...
output = {
    "meta": {
        "description": "Compiled baseline descriptives for LLMPhysics contest analysis",
        "n_files_loaded": len(baseline_files),
        "n_papers": len(per_paper),
